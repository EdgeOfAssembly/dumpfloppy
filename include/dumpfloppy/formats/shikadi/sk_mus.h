 ...
 */
#ifndef DUMPFLOPPY_FORMATS_SK_MUS_H
#define DUMPFLOPPY_FORMATS_SK_MUS_H
...
class sk_mus final : public file_format
{
public:
    ...
    {
        return "https://moddingwiki.shikadi.net/wiki/MUS_Format";
    }
    ...
    {
        static constexpr uint8_t k_m0_0[]{0x4D, 0x55, 0x53, 0x1A};
