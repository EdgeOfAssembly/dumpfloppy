 ...
 */
#ifndef DUMPFLOPPY_FORMATS_SK_GRP_H
#define DUMPFLOPPY_FORMATS_SK_GRP_H
...
class sk_grp final : public file_format
{
public:
    ...
    {
        return "https://moddingwiki.shikadi.net/wiki/GRP_Format";
    }
    ...
    {
        static constexpr uint8_t k_m0_0[]{0x4B, 0x65, 0x6E, 0x53, 0x69, 0x6C, 0x76, 0x65, 0x72, 0x6D, 0x61, 0x6E};
