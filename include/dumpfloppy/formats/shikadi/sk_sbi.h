 ...
 */
#ifndef DUMPFLOPPY_FORMATS_SK_SBI_H
#define DUMPFLOPPY_FORMATS_SK_SBI_H
...
class sk_sbi final : public file_format
{
public:
    ...
    {
        return "https://moddingwiki.shikadi.net/wiki/SBI_Format";
    }
    ...
    {
        static constexpr uint8_t k_m0_0[]{0x53, 0x42, 0x49, 0x1A};
