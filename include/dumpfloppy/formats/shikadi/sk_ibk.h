 ...
 */
#ifndef DUMPFLOPPY_FORMATS_SK_IBK_H
#define DUMPFLOPPY_FORMATS_SK_IBK_H
...
class sk_ibk final : public file_format
{
public:
    ...
    {
        return "https://moddingwiki.shikadi.net/wiki/IBK_Format";
    }
    ...
    {
        static constexpr uint8_t k_m0_0[]{0x49, 0x42, 0x4B, 0x1A};
