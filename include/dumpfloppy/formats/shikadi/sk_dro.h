 ...
 */
#ifndef DUMPFLOPPY_FORMATS_SK_DRO_H
#define DUMPFLOPPY_FORMATS_SK_DRO_H
...
class sk_dro final : public file_format
{
public:
    ...
    {
        return "https://moddingwiki.shikadi.net/wiki/DRO_Format";
    }
    ...
    {
        static constexpr uint8_t k_m0_0[]{0x44, 0x42, 0x52, 0x41, 0x57, 0x4F, 0x50, 0x4C};
