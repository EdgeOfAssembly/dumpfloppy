 ...
 * @file sk_xmi.h
 * @brief XMI Format
 * @see https://moddingwiki.shikadi.net/wiki/XMI_Format
 */
#ifndef DUMPFLOPPY_FORMATS_SK_XMI_H
#define DUMPFLOPPY_FORMATS_SK_XMI_H
...
class sk_xmi final : public file_format
{
public:
    ...
    {
        return "https://moddingwiki.shikadi.net/wiki/XMI_Format";
    }
    ...
    [[nodiscard]] bool detect(std::span<const uint8_t> data) const override
    {
        ...
        static constexpr uint8_t k_m0_1[]{0x58, 0x44, 0x49, 0x52};
